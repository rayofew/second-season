 ...
 * who has ever watched a punt — which is the whole point: the people using this know football far
 * better than the app does, and until now they had nothing to check it against.
 */
...
export function Breakdown({
  ...
  return (
    <div className="card breakdown">
      ...
      <div className="pending">
        {projected
          ? 'A projection, not a promise — these are the figures the feed expects, run through the league’s own scoring.'
